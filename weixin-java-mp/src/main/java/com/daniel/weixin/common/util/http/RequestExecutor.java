...
public interface RequestExecutor<T, E> {
  ...
  public T execute(CloseableHttpClient httpclient, HttpHost httpProxy, String uri, E data,String mpTag) throws WxErrorException, ClientProtocolException, IOException;
