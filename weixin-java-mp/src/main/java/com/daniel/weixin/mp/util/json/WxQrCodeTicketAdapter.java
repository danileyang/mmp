 ...
 *
 */
public class WxQrCodeTicketAdapter implements JsonDeserializer<com.daniel.weixin.mp.bean.result.WxMpQrCodeTicket> {

  public com.daniel.weixin.mp.bean.result.WxMpQrCodeTicket deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
    com.daniel.weixin.mp.bean.result.WxMpQrCodeTicket ticket = new com.daniel.weixin.mp.bean.result.WxMpQrCodeTicket();
