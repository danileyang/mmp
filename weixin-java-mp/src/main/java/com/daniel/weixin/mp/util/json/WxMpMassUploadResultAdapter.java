 ...
 *
 */
public class WxMpMassUploadResultAdapter implements JsonDeserializer<com.daniel.weixin.mp.bean.result.WxMpMassUploadResult> {

  public com.daniel.weixin.mp.bean.result.WxMpMassUploadResult deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
    com.daniel.weixin.mp.bean.result.WxMpMassUploadResult uploadResult = new com.daniel.weixin.mp.bean.result.WxMpMassUploadResult();
