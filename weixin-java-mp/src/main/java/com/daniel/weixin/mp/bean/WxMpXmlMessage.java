...
public class WxMpXmlMessage implements Serializable {
  ...
  public static WxMpXmlMessage fromXml(String xml) {
    return com.daniel.weixin.mp.util.xml.XStreamTransformer.fromXml(WxMpXmlMessage.class, xml);
  }

  public static WxMpXmlMessage fromXml(InputStream is) {
    return com.daniel.weixin.mp.util.xml.XStreamTransformer.fromXml(WxMpXmlMessage.class, is);
  }
  ...
  public static WxMpXmlMessage fromEncryptedXml(
    ...
    com.daniel.weixin.mp.util.crypto.WxMpCryptUtil cryptUtil = new com.daniel.weixin.mp.util.crypto.WxMpCryptUtil(wxMpConfigStorage);
