...
public class WxMpMassOpenIdsMessageGsonAdapter implements JsonSerializer<com.daniel.weixin.mp.bean.WxMpMassOpenIdsMessage> {

  public JsonElement serialize(com.daniel.weixin.mp.bean.WxMpMassOpenIdsMessage message, Type typeOfSrc, JsonSerializationContext context) {
