...
public class WxMpCustomMessageGsonAdapter implements JsonSerializer<com.daniel.weixin.mp.bean.WxMpCustomMessage> {

  public JsonElement serialize(com.daniel.weixin.mp.bean.WxMpCustomMessage message, Type typeOfSrc, JsonSerializationContext context) {
    ...
    if (WxConsts.CUSTOM_MSG_NEWS.equals(message.getMsgType())) {
      ...
      for (com.daniel.weixin.mp.bean.WxMpCustomMessage.WxArticle article : message.getArticles()) {
