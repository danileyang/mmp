...
public class WxMpMessageRouterRule {
  ...
  private final com.daniel.weixin.mp.api.WxMpMessageRouter routerBuilder;
  ...
  private com.daniel.weixin.mp.api.WxMpMessageMatcher matcher;

  private boolean reEnter = false;

  private List<com.daniel.weixin.mp.api.WxMpMessageHandler> handlers = new ArrayList<com.daniel.weixin.mp.api.WxMpMessageHandler>();

  private List<WxMpMessageInterceptor> interceptors = new ArrayList<WxMpMessageInterceptor>();

  public WxMpMessageRouterRule(com.daniel.weixin.mp.api.WxMpMessageRouter routerBuilder) {
   ...
   * @return
   */
  public WxMpMessageRouterRule matcher(com.daniel.weixin.mp.api.WxMpMessageMatcher matcher) {
   ...
   * @return
   */
  public WxMpMessageRouterRule handler(com.daniel.weixin.mp.api.WxMpMessageHandler handler) {
    return handler(handler, (com.daniel.weixin.mp.api.WxMpMessageHandler[]) null);
  }
   ...
   * @return
   */
  public WxMpMessageRouterRule handler(com.daniel.weixin.mp.api.WxMpMessageHandler handler, com.daniel.weixin.mp.api.WxMpMessageHandler... otherHandlers) {
    this.handlers.add(handler);
    if (otherHandlers != null && otherHandlers.length > 0) {
      for (com.daniel.weixin.mp.api.WxMpMessageHandler i : otherHandlers) {
        this.handlers.add(i);
      }
    }
    return this;
   ...
   * @return
   */
  public com.daniel.weixin.mp.api.WxMpMessageRouter end() {
   ...
   * @return
   */
  public com.daniel.weixin.mp.api.WxMpMessageRouter next() {
    this.reEnter = true;
    return end();
  }

  protected boolean test(com.daniel.weixin.mp.bean.WxMpXmlMessage wxMessage) {
    return
   ...
   */
  protected com.daniel.weixin.mp.bean.WxMpXmlOutMessage service(com.daniel.weixin.mp.bean.WxMpXmlMessage wxMessage,
    ...
    try {
      ...
      for (com.daniel.weixin.mp.api.WxMpMessageHandler handler : this.handlers) {
        // 返回最后handler的结果
  ...
  public com.daniel.weixin.mp.api.WxMpMessageRouter getRouterBuilder() {
  ...
  public com.daniel.weixin.mp.api.WxMpMessageMatcher getMatcher() {
    return matcher;
  }

  public void setMatcher(com.daniel.weixin.mp.api.WxMpMessageMatcher matcher) {
    this.matcher = matcher;
  }
  ...
  public List<com.daniel.weixin.mp.api.WxMpMessageHandler> getHandlers() {
    return handlers;
  }

  public void setHandlers(List<com.daniel.weixin.mp.api.WxMpMessageHandler> handlers) {
