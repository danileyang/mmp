...
public class WxUserListGsonAdapter implements JsonDeserializer<com.daniel.weixin.mp.bean.result.WxMpUserList> {

  public com.daniel.weixin.mp.bean.result.WxMpUserList deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
    JsonObject o = json.getAsJsonObject();
    com.daniel.weixin.mp.bean.result.WxMpUserList wxMpUserList = new com.daniel.weixin.mp.bean.result.WxMpUserList();
