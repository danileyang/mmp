 ...
 */
public final class MusicBuilder extends com.daniel.weixin.mp.bean.outxmlbuilder.BaseBuilder<MusicBuilder, com.daniel.weixin.mp.bean.WxMpXmlOutMusicMessage> {
  ...
  public com.daniel.weixin.mp.bean.WxMpXmlOutMusicMessage build() {
    com.daniel.weixin.mp.bean.WxMpXmlOutMusicMessage m = new com.daniel.weixin.mp.bean.WxMpXmlOutMusicMessage();
    setCommon(m);
    m.setTitle(title);
