...
public class WxMpMassGroupMessageGsonAdapter implements JsonSerializer<com.daniel.weixin.mp.bean.WxMpMassGroupMessage> {

  public JsonElement serialize(com.daniel.weixin.mp.bean.WxMpMassGroupMessage message, Type typeOfSrc, JsonSerializationContext context) {
